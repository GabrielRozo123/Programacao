...
=====================================
Versão 5.10 — 16/Mai/2026  ★ FIX FOLGA SEPARADOR 20% × ELETRODOS ★

CORREÇÃO v5.10 (sobre v5.9):
  ✅ Conflito vertical detectado entre o separador 20% e o topo
     dos eletrodos.  As placas inclinadas do Λ inferior desciam
     0,385 m abaixo do pico (W/2 × sin(47,5°)), entrando na zona
     dos eletrodos (topo em z=2,65 m).
       • z_pico nominal = 2,920 m
       • z_borda inferior placas = 2,920 − 0,385 = 2,535 m
       • z_topo eletrodos = 2,650 m
       • Sobreposição: 115 mm  ⚠

     Fix: a cota nominal (pct × H) agora representa a BORDA INFERIOR
     do conjunto Λ (cota mais baixa das placas externas), não o pico.
     O pico é posicionado em z_base + W/2 × sin(tilt) acima.
     Para o sep. 20%:  pico vai para z=3,305 m  →  folga 0,27 m ✓

  ✅ Adicionada função _check_clearances() que verifica e imprime
     as folgas críticas antes de construir a geometria.  Levanta
     AssertionError se folga vertical for menor que 5 cm.

REVISÃO COMPLETA v5.10: verifiquei 22 pares de componentes (sep × elec,
DN100 × sep, ramais × elec, bocais × sep, sep × DN50, difusores × elec,
etc.).  Apenas o par sep. 20% × eletrodos tinha problema.  Os demais
21 pares estão com folgas adequadas.

Demais features mantidas da v5.9:
  • Λs com pico para cima (corrigido na v5.9)
  • Manifold de 4 ramais DN50 (v5.8)
  • Separadores 2/4/4/4 (v5.7)
  • Topo convexo + saída biogás + efluente lateral (v5.6)
  • Bocais 80°/+7° anti-horário, eletrodos 2 pares, 12 difusores
"""
...
print("=" * 64)
print("FIORA IC v5.10 — Fix folga sep. 20% × eletrodos + revisão completa")
print("=" * 64)
...
cq.exporters.export(fluid, "FIORA_IC_v5_10_fluid_domain.step")
print("  ✅ FIORA_IC_v5_10_fluid_domain.step")
cq.exporters.export(tube, "FIORA_IC_v5_10_return_tube.step")
print("  ✅ FIORA_IC_v5_10_return_tube.step  (★ tubo + 4 ramais)")
cq.exporters.export(_union(sep_list), "FIORA_IC_v5_10_separators.step")
print("  ✅ FIORA_IC_v5_10_separators.step")
cq.exporters.export(_union(noz_list), "FIORA_IC_v5_10_nozzles.step")
print("  ✅ FIORA_IC_v5_10_nozzles.step")
cq.exporters.export(_union(elec_list), "FIORA_IC_v5_10_electrodes.step")
print("  ✅ FIORA_IC_v5_10_electrodes.step")
cq.exporters.export(_union(diff_list), "FIORA_IC_v5_10_diffusers.step")
print("  ✅ FIORA_IC_v5_10_diffusers.step")
