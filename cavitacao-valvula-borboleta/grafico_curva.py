...
def main():
    ...
    pmin_m = [pmin for _, _, _, pmin in MEDIDO]
    ...
    dp_cat = [0.3 + 3.4 * i / 199 for i in range(200)]
    ...
    ax1.annotate(f"estrangulamento previsto\n$\\Delta P$ = {dpc:.2f} bar"
                 ...
                 xy=(dpc + 0.05, q_max), xytext=(dpc + 0.42, q_max - 33),
