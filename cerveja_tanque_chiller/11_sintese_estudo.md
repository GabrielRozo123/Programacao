...
|---|---|---|---|
| T_bulk → −4,9 °C (99%) | ~7500 s* | **3040 s** ⚡ | **4930 s** |
| Pico de estratificação (ΔT topo–fundo) | — | 9,6 °C | **4,7 °C** 🎯 |
| Regime (vs CSTR ideal = 4849 s) | pior que CSTR | **bate CSTR −37%** | **≈ CSTR** |

> Sim 1 e Sim 2 = **transiente real** (`12_verificacao_transiente.md`). **Sim 1 (deslocamento) bate a mistura;
> Sim 2 (recirc) assenta no limite CSTR** → confirma que a recirc destrói a vantagem do deslocamento.
> *Baseline ainda estimado (falta T_bulk completo). Critério: T_bulk = −4,9 °C ("−5 °C" é assíntota).
