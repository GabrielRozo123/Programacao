...
=====================================
Versão 5.8 — 16/Mai/2026  ★ MANIFOLD DE 4 RAMAIS NO RETORNO DN100 ★

ATUALIZAÇÃO v5.8 (sobre v5.7):
  ✅ Tubo de retorno DN100 agora termina num MANIFOLD com 4 ramais
     DN50 horizontais — melhora a distribuição do líquido recirculado
     na zona de mistura do fundo.

     Sugestão Vinícius (áudio + croqui 16/05): "esse tubo aí que desce
     ele tem 4 ramais distribuindo no fundo".

     Geometria:
       • Tubo principal DN100 vertical: z = 0,40 m → z = 14,29 m
       • Manifold em z = 0,40 m (cota dos 4 ramais)
       • 4 ramais DN50 horizontais saindo radialmente do manifold
         em azimutes 45°, 135°, 225°, 315° (entre bocais e fora da
         direção dos eletrodos)
       • Comprimento de cada ramal: 0,70 m (vai do eixo até r=0,7 m,
         folga 35 cm da parede)
       • Ramais com extremidade aberta (descarga livre)
       • Conserva área hidráulica: 4 × A(DN50) ≈ A(DN100)

     Verificações de não-conflito:
       • Ramais em 45/135/225/315°  vs  bocais em 0/60/120/180/240/300°
         → distância angular mínima 15° (ramais 45°/315° vs bocal 0°/60°)
       • Ramais em 45/135/225/315°  vs  eletrodos em 0°/180°
         → distância angular mínima 45° — folga radial confortável
       • Ramais em z=0,40 m  vs  bocais em z=0,25 m (Δz=15cm, ok)
       • Ramais em z=0,40 m  vs  difusores em z=0 (Δz=40cm, ok)
       • Ramais em z=0,40 m  vs  eletrodos z=0,25→2,65 m
         → conflito vertical NÃO HÁ porque azimutes são diferentes

Tudo o mais (v5.7) mantido sem mudança:
  • Topo convexo + saída biogás central + efluente lateral z=14,30
  • 3 DN50 laterais (níveis 20/40/60%)
  • Separadores 2/4/4/4 Λ por nível
  • Bocais 6× DN80, 80°/+7°, anti-horário
  • Eletrodos 2 pares A/C, gap 30 mm
  • Difusores 12× DN250 no fundo
"""
...
# Tubo de retorno DN100 + manifold de 4 ramais  ★ v5.8 ★
D_RETURN_OUT  = 0.100
WALL_RETURN   = 0.004
...
# Ramais DN50 (4× horizontais no manifold)  ★ v5.8 ★
D_BRANCH      = 0.050                   # DN50
...
# ═══════════════════════════════════════════════════════
# TUBO DE RETORNO + MANIFOLD DE 4 RAMAIS  ★ v5.8 ★
# ═══════════════════════════════════════════════════════
...
def build_return_tube_with_manifold():
    ...
    """
    print(f"  [6] Tubo retorno DN100 + 4 ramais DN50  ★ v5.8 ★")
...
print("=" * 64)
print("FIORA IC v5.8 — Manifold de 4 ramais no retorno DN100")
print("=" * 64)
...
cq.exporters.export(fluid, "FIORA_IC_v5_8_fluid_domain.step")
print("  ✅ FIORA_IC_v5_8_fluid_domain.step")
cq.exporters.export(tube, "FIORA_IC_v5_8_return_tube.step")
print("  ✅ FIORA_IC_v5_8_return_tube.step  (★ tubo + 4 ramais)")
cq.exporters.export(_union(sep_list), "FIORA_IC_v5_8_separators.step")
print("  ✅ FIORA_IC_v5_8_separators.step")
cq.exporters.export(_union(noz_list), "FIORA_IC_v5_8_nozzles.step")
print("  ✅ FIORA_IC_v5_8_nozzles.step")
cq.exporters.export(_union(elec_list), "FIORA_IC_v5_8_electrodes.step")
print("  ✅ FIORA_IC_v5_8_electrodes.step")
cq.exporters.export(_union(diff_list), "FIORA_IC_v5_8_diffusers.step")
print("  ✅ FIORA_IC_v5_8_diffusers.step")

print("\n" + "=" * 64)
print("v5.8 CONCLUÍDO — Manifold de 4 ramais implementado")
print("=" * 64)
print(f"""
MUDANÇA v5.8 vs v5.7:
  Antes (v5.7): tubo DN100 vertical único de z=14,29 → 0,15 m
  Agora (v5.8): tubo DN100 vertical de z=14,29 → 0,40 m + manifold
