...
def fase1():
    ...
    print("  RADIAL por construcao.")
    print("-" * 76)
    print("  CORRECAO -- este texto dizia antes 'AMUSIG multi-velocidade ou")
    print("  S-Gamma'. O S-Gamma NAO serve para isso, por duas razoes")
    print("  estruturais:")
    print("     1. ele assume forma LOG-NORMAL para a distribuicao, que e")
    print("        unimodal -- nao representa dois picos")
    print("     2. ele transporta momentos num UNICO campo de velocidade --")
    print("        todas as bolhas andam juntas, entao nao existe separacao")
    print("        parede/centro nem com a forma certa")
    print("  Para a SEGREGACAO so serve AMUSIG multi-velocidade.")
    print("-" * 76)
    print("  O S-Gamma serve para outra coisa, e serve bem: prever o d32, que")
    print("  e o que governa o arrasto e portanto o holdup GLOBAL. Sao alvos")
    print("  diferentes e cada modelo atende o seu.")
    print("=" * 76)
